...
@Mojo(name="cnpm",  defaultPhase = LifecyclePhase.GENERATE_RESOURCES, threadSafe = true)
public final class CnpmMojo extends AbstractFrontendMojo {
    ...
    public synchronized void execute(FrontendPluginFactory factory) throws TaskRunnerException {
        ...
        if (buildContext == null || buildContext.hasDelta(packageJson) || !buildContext.isIncremental()) {
            ...
            factory.getCnpmRunner(proxyConfig, getRegistryUrl()).execute(arguments, environmentVariables);
        } else {
